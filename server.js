...
// Middleware
app.use(cors({ origin: ["http://localhost:5173", "https://payslip.eliteservices.co.ke"], methods: ["GET", "POST"], allowedHeaders: ["Content-Type"] }));
...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 5px 0; font-size: 18px; color:rgb(11, 107, 202); }
...
app.get("/api/download-payslip/:employee_id", (req, res) => {
